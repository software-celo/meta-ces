...
# Disable promt Use default config or One empty panel and use default config on xfce, and set positon of taskbar icons and taskbar
        install -m 0755 -d ${D}/home/root/.config/xfce4/panel
        install -m 0644 ${WORKDIR}/default.xml ${D}/home/root/.config/xfce4/panel/default.xml

# taskbar icons
        install -m 0755 -d ${D}/home/root/.config/xfce4/panel/launcher-9
        install -m 0644 ${WORKDIR}/launcher-9/15306022021.desktop ${D}/home/root/.config/xfce4/panel/launcher-9/15306022021.desktop
        install -m 0755 -d ${D}/home/root/.config/xfce4/panel/launcher-10
        install -m 0644 ${WORKDIR}/launcher-10/15306022022.desktop ${D}/home/root/.config/xfce4/panel/launcher-10/15306022022.desktop
        install -m 0755 -d ${D}/home/root/.config/xfce4/panel/launcher-18
        install -m 0644 ${WORKDIR}/launcher-18/15306135134.desktop ${D}/home/root/.config/xfce4/panel/launcher-18/15306135134.desktop
        install -m 0644 ${WORKDIR}/cpugraph-17.rc ${D}/home/root/.config/xfce4/panel/cpugraph-17.rc
...
# xfwm4.xml set two workspaces in tasktbar not std 4, disable display compositing to prevent mouse cursor flickering
        ...
        install -m 0644 ${WORKDIR}/xfwm4.xml ${D}/home/root/.config/xfce4/xfconf/xfce-perchannel-xml/xfwm4.xml

# Set christ logo as desktop background for all users, hide desktop icon home, filesystem, trash, removable
	install -m 0644 ${WORKDIR}/xfce4-desktop.xml ${D}/home/root/.config/xfce4/xfconf/xfce-perchannel-xml/xfce4-desktop.xml
...
# Copy README to Desktop
	install -m 0755 -d ${D}/home/root/Desktop
        install -m 0644 ${WORKDIR}/README.txt ${D}/home/root/Desktop/README.txt

# Show root@pixi-cdl100:/# in terminal, in xfce-terminal enable Run command as login shell
	install -m 0755 -d ${D}/home/root/.config/xfce4/terminal
	install -m 0644 ${WORKDIR}/terminalrc ${D}/home/root/.config/xfce4/terminal/terminalrc

# Run shell scpripts on thunar by default
        install -m 0644 ${WORKDIR}/thunar/thunar.xml ${D}/home/root/.config/xfce4/xfconf/xfce-perchannel-xml/thunar.xml

# Assignment which file is open with which application in thunar
        install -m 0755 -d ${D}/home/root/.config
        install -m 0644 ${WORKDIR}/thunar/mimeapps-thunar.list ${D}/home/root/.config/mimeapps.list
}

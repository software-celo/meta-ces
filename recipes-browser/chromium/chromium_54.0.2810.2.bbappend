...
CHROMIUM_EXTRA_ARGS += " --num-raster-threads=2 --window-depth=24 --flag-switches-begin --ignore-gpu-blacklist \
                         --flag-switches-end --touch-events=enabled --gpu-sandbox-start-early \
